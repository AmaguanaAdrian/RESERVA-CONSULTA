...
public class ControladorReservasActivas {
    ...
    private void cargarReservasActivas() {
        ...
        for (Reserva r : reservas) {
            ...
            String nombreEstudiante = reservaDAO.obtenerNombreEstudiante(r.getIdEstudiante());
            
            // Obtener título del libro
            String tituloLibro = reservaDAO.obtenerTituloLibro(r.getIdLibro());
            ...
            modeloReservas.addRow(new Object[]{
                ...
                r.getFechaLimite().format(formatter),
